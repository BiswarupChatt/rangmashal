          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography
                ...
                textAlign="justify"
              >
                At Rangmashal Foundation, we believe that every child and woman
                has the potential to succeed, regardless of their background.
                That is why we have dedicated ourselves to empowering them and
                providing them with the resources they need irrespective of
                their background since our establishment in 2020.
              </Typography>

              <Button
                label="More About Us"
                navigateTo="/who-we-are/about"
