const eventsData = [
    ...
    },
    {
        ...
        subEvents: [
            ...
            },
            {
                ...
                subDescription: 'In Sundarbans, we extended warmth and compassion by distributing food and clothes to 500 people. This simple act aimed to bring relief to those in need, fostering a sense of community and solidarity in the heart of the picturesque Sundarbans region.',
        ...
        subEvents: [
            {
                ...
                subDescription: 'Team “Rangmashal Foundation” had organized their very first activity on 14th February, 2020. We distributed blankets, food packets, and water bottles to the homeless, spreading love on Valentine’s Day.',
                date: '14th February, 2020',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
            {
                subTitle: 'December er Sohorey',
                subDescription: 'On 28th December 2020, we distributed 120 blankets, masks, sanitizers, and food packets to homeless people in South Kolkata.',
        ...
        subEvents: [
            {
                ...
                subDescription: 'On 11th October 2020, we visited Save the Orphans in Rania, spending time with kids, providing them meals, masks, and gifts.',
                date: '11th October, 2020',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
            {
                subTitle: 'Sharodiyar Porosh 1.0 - Phase 2',
                subDescription: 'On 18th October 2020, we visited Cheshire Homes Kolkata and provided new clothes and wheelchairs to the residents before Durga Puja.',
                date: '18th October, 2020',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
            {
                subTitle: 'Sharadiyar Parash 2.0',
                subDescription: 'In 2021, we shared happiness with street children through gifts and provided clothing to Dhakis during Durga Puja.',
                date: 'September - October, 2021',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
            {
                subTitle: 'Sharadiyar Parash 3.0',
                subDescription: 'In 2022, we continued our efforts, gifting street children and needy women, and organizing puja tours for children.',
        ...
        subEvents: [
            {
                ...
                subDescription: 'In April 2021, we provided school bags and gifts to 45 children at Boral Student’s Club, ensuring they had the necessities.',
                date: '18th April, 2021',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
            {
                subTitle: 'Embrace of Love: Part 1',
                subDescription: 'On 22nd July 2021, we organized a special lunch and provided daily essentials to the kids at Calcutta Orphanage.',
                date: '22nd July, 2021',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
            {
                subTitle: 'Swapno ki Ashiyana',
                subDescription: 'In August 2022, we supported the reconstruction of a school destroyed by rain and provided stationary kits to the children.',
        ...
        subEvents: [
            {
                ...
                subDescription: 'On 14th October, we organized a health camp providing free checkups, ECG, diabetes tests, and consultations for over 80 people.',
                date: '14th October',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
        ],
        ...
        subEvents: [
            {
                ...
                subDescription: 'Amid the COVID pandemic, we offered free oxygen, medicines, and safe patient transfers to both home and hospital settings.',
                date: '2020-2021',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
        ],
        ...
        subEvents: [
            {
                ...
                subDescription: 'On 16th April 2021, we were invited by Canara Bank for a workshop on Dr. B.R. Ambedkar’s birth anniversary, where we took 10 children to receive gifts.',
                date: '16th April, 2021',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
            {
                subTitle: 'Dress donated by Worley',
                subDescription: 'During Durga Puja, Worley donated clothes to children and other individuals in need, adding warmth and joy to the festive season.',
                date: 'October 2021',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
        ],
    },
    {
        ...
        subEvents: [
            {
                subTitle: 'Ignite',
                subDescription: 'On 21st November 2021, we organized a drawing competition for underprivileged students and held an awareness program for their parents on education and health.',
                date: '21st November, 2021',
                images: ['https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899302/Website/nt81qnkkkvjcch48v53k.jpg', 'https://res.cloudinary.com/dgwgnfulm/image/upload/v1725899112/Website/lwijqhxavefwc1ftue0e.jpg'],
            },
            {
                subTitle: 'Dwitio Porikolpona',
                subDescription: 'On 12th March 2020, we visited Pratapgarh Free Primary School and organized an art competition and projector show, spreading joy among the children.',
