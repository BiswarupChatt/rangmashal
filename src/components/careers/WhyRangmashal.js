...
const data = [
  {
    ...
    description:
      "Your efforts will directly contribute to empowering underprivileged children and women, helping us create a brighter future for communities across India.",
  },
  {
    icon: (
      <PersonalDevelopmentIcon sx={{ fontSize: 50, color: "primary.main" }} />
    ),
    title: "Personal Development",
    description:
      "Gain invaluable skills and experience that will enhance your personal and professional growth, while building your leadership capabilities.",
  },
  {
    icon: <YouthMovementIcon sx={{ fontSize: 50, color: "primary.main" }} />,
    title: "Join a Youth-Driven Movement",
    description:
      "Be a part of a dynamic team of young change makers, where your passion and creativity can truly make a difference.",
  },
];
        ...
        <Slide direction="up" cascade damping={1} triggerOnce>
          <Fade cascade triggerOnce>
            <Box>
              ...
              >
                We offer flexible and meaningful partnership avenues designed to
