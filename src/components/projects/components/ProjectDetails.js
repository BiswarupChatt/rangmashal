          ...
          <Fade cascade triggerOnce>
            <Grid container spacing={4} alignItems="center">
              <Grid
                ...
                xs={12}
                md={6}
                sx={{ order: { xs: gridOrder.xsFirst, md: gridOrder.mdFirst } }}
              >
                <Swiper
              ...
              <Grid
                ...
                md={6}
                sx={{
                  order: { xs: gridOrder.xsSecond, md: gridOrder.mdSecond },
                }}
              >
                <Box sx={{ padding: { xs: "20px 0", md: "0 20px" } }}>
                  ...
                  <DonateButton
                    label={events.buttonTitle}
                    bgColor={buttonColor}
                    bgColorHover={buttonColorHover}
                    sx={{ marginTop: 2 }}
                  />
                </Box>
              </Grid>
