    ...
    <Box sx={{ width: "100%" }}>
      <Container sx={{ padding: { xs: "20px", md: "50px" } }}>
        ...
        <Typography variant="body1" sx={{ textAlign: "justify", mb: 3 }}>
          At Rangmashal, we envision a world where every child thrives. Our
          partnerships with corporations are essential not only for fulfilling
          CSR commitments but for driving impactful change in the lives of
