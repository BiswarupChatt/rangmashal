...
export default function Footer() {
  ...
  const socialLinks = [
    {
      icon: <FacebookIcon />,
      url: "https://www.facebook.com/rangmashalfoundation?mibextid=LQQJ4d",
    },
    {
      icon: <InstagramIcon />,
      url: "https://www.instagram.com/rangmashalorg?igsh=c2J2aXVjZmNrYnc5",
    },
    {
      icon: <LinkedInIcon />,
      url: "https://www.linkedin.com/company/rangmashalfoundation/",
    },
    {
      icon: <YouTubeIcon />,
      url: "https://youtube.com/@rangmashalfoundation?si=SYWJm9kKjk4H9IZZ",
    },
  ];
  ...
  const infoItems = [
    ...
    },
    {
      ...
      text: "Donations to us are fully tax-exempt under 80G of the Indian Income Tax Act, amplifying the impact of your generosity.",
    },
    {
